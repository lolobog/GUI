...
void Box::draw_lines() const
{
	if (fill_color().visibility()) {	// fill
		fl_color(color().as_int());
		fl_line(point(0).x - w, point(0).y - (h / 2.5), point(0).x - w, point(0).y + (h / 2.5));
		fl_line(point(0).x + w, point(0).y - (h / 2.5), point(0).x + w, point(0).y + (h / 2.5));
		fl_line(point(0).x + (w / 1.5), point(0).y - h, point(0).x - (w / 1.5), point(0).y - h);
		fl_line(point(0).x + (w / 1.5), point(0).y + h, point(0).x - (w / 1.5), point(0).y + h);
		fl_begin_line();
		fl_arc(point(0).x - w + 70, point(0).y - (h / 2) + 20, 70, 180, 90);
		fl_end_line();
		fl_begin_line();
		fl_arc(point(0).x - w + 70, point(0).y + (h / 2) - 20, 70, 180, 270);
		fl_end_line();
		fl_begin_line();
		fl_arc(point(0).x + w - 70, point(0).y - (h / 2) + 20, 70, 0, 90);
		fl_end_line();
		fl_begin_line();
		fl_arc(point(0).x + w - 70, point(0).y + (h / 2) - 20, 70, 270, 360);
		fl_end_line();
		fl_color(color().as_int());	// reset color
	}
...
void Regular_Hexagon::draw_lines() const
{
	if (fill_color().visibility()) {	// fill
		fl_color(fill_color().as_int());
		fl_line(point(0).x + (d / 2), point(0).y + a, point(0).x - (d / 2), point(0).y + a);
