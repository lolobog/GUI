...
struct Regular_Hexagon : Shape {
	...
	Regular_Hexagon(Point xy, int dd) :d{ dd } {}
...
struct Arc :Shape
{
	Arc(Point p, int ww, int hh,int sa,int ea)	// center, min, and max distance from center
		:w{ ww }, h{ hh }, start{ sa }, end{ ea } {
